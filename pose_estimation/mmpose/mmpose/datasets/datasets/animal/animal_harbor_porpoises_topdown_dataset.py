...
@DATASETS.register_module(name='HarborPorpoisesTopDownCocoDataset')
class HarborPorpoisesTopDownCocoDataset(Kpt2dSviewRgbImgTopDownDataset):
    """
    Harbor-Porpoises-Pose dataset for harbor porpoises pose estimation.

    Harbor-Porpoises-Pose keypoint indexes::
    ...
    def __init__(self,
        ...
        if dataset_info is None:
            ...
            cfg = Config.fromfile('configs/_base_/datasets/harbor_porpoises.py')
