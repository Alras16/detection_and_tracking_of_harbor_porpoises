...
parser.add_argument('detections', help='Text file in MOT format with detections, frames and IDs')
args = parser.parse_args()

detection_file = "data/detections/" + args.detections
