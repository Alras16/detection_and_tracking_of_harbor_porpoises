...
parser.add_argument("image_dir", type=str, help="Path to video directory")
...
with open(args.coco_json, 'w') as coco_file:
    json.dump(data, coco_file, indent=2, sort_keys=True, cls=NumpyEncoder)

#python sleap_training_data/fix.py sleap_training_data/labels_packages/labels_with_images.pkg.slp images/example.json images/example/ """


import sleap
labels = sleap.load_file("labels_packages/1017_labeled_frames_in_14_videos.pkg.slp")
print(len(labels.skeletons))
